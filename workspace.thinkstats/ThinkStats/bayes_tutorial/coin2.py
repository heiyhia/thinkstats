...
def main():
    ...
    print 'Likelihood if biased', likelihood_biased

    likelihood_fair = Likelihood(evidence, 0.5)
    print 'Likelihood if fair', likelihood_fair

    ratio = likelihood_biased / likelihood_fair
    print 'Likelihood ratio in favor of biased', ratio
