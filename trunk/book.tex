...
fit a lognormal model.  In Chapter~\ref{correlation} we will come back
...
If we have no reason to think one hypothesis is more likely than another,
it is common to assign each 
...
different priors will eventually converge to the same posterior
probability.
