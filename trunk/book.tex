...
You can download a solution to this problem from
\url{thinkstats.py/class\_size.py}.
...
To test your function, let's get the distribution of speeds from
a normal road race (not a relay).
