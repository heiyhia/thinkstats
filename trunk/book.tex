...
probability and $P(H|E)$ is called the {\bf posterior}.  The ratio
$P(E|H)/P(E)$ is the update factor.
...
Hint: you might want to start by computing the MSE you would get if you
ignore the SAT score and always guess 100.
