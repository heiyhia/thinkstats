...
would be a trial.  Each time a 6 appeared would be considered a
{\bf success}; the other trials would be considered {\bf failures}.
...
well-defined probability for this event because there is no series
of trials.  He either is or he isn't; it's not a question of probability.
...
Then if you consulted the Wikipedia, you would learn that Thaksin
is not the PM, at least at the time I am writing, and you might
revise your probability estimate to $0.01$, reflecting the possibility
that the Wikipedia is wrong.
