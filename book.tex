...
Optional: The Gini coefficient is a measure of income inequality.
...
\item[correlation:] a description of
the dependence between variables.

\item[normalize:] Transform a set of values so that their mean is 0 and
their variance is 1.
