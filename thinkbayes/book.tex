...
Suppose that this factor is 2.  Looking at the term on the right,
we could say, ``The data
are twice as likely under $H$ than under $\bar{H}$.''  Looking
at the term on the left, we might say ``The odds of $H$ 

This equation implies that 
If this value is greater than $1$, that means that the data were more
likely under $H$ than under $\bar{H}$.  And since the odds ratio is
also greater than $1$, which means that the odds are greater, in light
of the data, than they were before.

If the Bayes factor is less than $1$, that means the data

the posterior odds are smaller.
And if the Bayes factor is exactly $1$ 

If the probability of the hypothesis increases, the odds must
increase, too.  


Returning to the cookie problem, we might say that the vanilla

What does it mean to da


What does it mean to say that 

The odds form of Bayes's Theorem is also
