...
So the difference between the priors is much smaller.

If more data are not available, the alternative it to improve the
...
orders of magnitude, or decades, based on
number of employees or income,

If we assume that the number of locomotives follows the same law,
we can construct a prior with 

I ran the program again with a uniform distribution from 1 to
2000.  


check whether the results are sensitive to the priors
